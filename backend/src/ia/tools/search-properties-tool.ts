...
export class SearchPropertiesTool extends LlmTool {
  ...
  public getInstance(): LlmToolType {
    return {
      ...
      name: "busca-propriedades",
      schema: z.object({
        user_id: z.string(),
      }),
      description:
        "Busca uma lista de propriedades de acordo com as preferências do usuário",
    };
  }

  private async execute(
    input: typeof SearchPropertiesUseCase.Input
  ): Promise<string> {
