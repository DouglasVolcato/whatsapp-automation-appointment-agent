...
export class UpdateUserPreferencesTool extends LlmTool {
  protected readonly updateUserPreferences: UpdateUserPreferencesUseCase.Service;
  protected readonly getUserPreferences: GetUserPreferencesUseCase.Service;
  protected readonly searchProperties: SearchPropertiesUseCase.Service;
  ...
  public constructor() {
    super();
    this.updateUserPreferences = new UpdateUserPreferencesUseCase.Service();
  ...
  public getInstance(): LlmToolType {
    return {
      ...
      description: `Atualiza as preferências do usuário relacionadas a propriedades. 
        ...
        Se atualizar a cidade, por exemplo, poderá atualizar o estado e o país também, mas não é obrigatório.`,
    };
  }
  ...
  protected async execute(
    ...
    await this.updateUserPreferences.execute(input);
  ...
  protected formatPropertiesWhatsappMessage(
